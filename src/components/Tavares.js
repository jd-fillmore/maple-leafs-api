...
import headerImg from "../img/tavares-main.jpg";
import TavaresImg from "../img/tavares.jpg";

function Tavares({ data, dataFull }) {
  return (
    <>
      <Container>
        <Row>
        ...
        <Row>
          <CardWrap>
            <Card>
              <Hero>
                <img src={headerImg} alt="tavares header" />
              </Hero>
              <Col lg="12">
                <ProfileCard>
                  <img src={TavaresImg} alt="tavares headshot" />
                  {data.map(item => (
                    <>
                      <h1>{item.fullName}</h1>
                      <h4>
