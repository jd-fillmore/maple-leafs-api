...
import headerImg from "../img/marner-main.jpg";
import MarnerImg from "../img/marner.jpg";

function Marner({ data, dataFull }) {
  return (
    <>
      <Container>
        <Row>
        ...
        <Row>
          <CardWrap>
            <Card>
              <Hero>
                <img src={headerImg} alt="Marner header" />
              </Hero>
              <Col lg="12">
                <ProfileCard>
                  <img src={MarnerImg} alt="Marner headshot" />
                  {data.map(item => (
                    <>
                      <h1>{item.fullName}</h1>
                      <h4>
